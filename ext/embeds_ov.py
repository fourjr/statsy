...
async def format_profile(ctx, name, p, h):
    ...
    if h["stats"]["competitive"]:
        ...
        for hero in hero_playtime_comp:
            ...
            em.add_field(name="Gold Medals", value=int(gen_comp_stats["medals_gold"]))
            em.add_field(name="Silver Medals", value=int(gen_comp_stats["medals_silver"]))
            em.add_field(name="Bronze Medals", value=int(gen_comp_stats["medals_bronze"]))
    ...
    for hero in hero_playtime_quick:
        ...
        em.add_field(name="Gold Medals", value=int(gen_quickplay_stats["medals_gold"]))
        em.add_field(name="Silver Medals", value=int(gen_quickplay_stats["medals_silver"]))
        em.add_field(name="Bronze Medals", value=int(gen_quickplay_stats["medals_bronze"]))
